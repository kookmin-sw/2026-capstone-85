...
+ (void)assertCollectionDTO:(AccountitAPICollectionResponse *)DTO
    ...
    XCTAssertEqual([[DTO items] count], 1U);
    XCTAssertTrue([[[DTO items] objectAtIndex:0] isKindOfClass:itemClass]);
    XCTAssertEqualObjects([[[DTO items] objectAtIndex:0] stringForKey:@"id"], @"item-1");
    XCTAssertEqualObjects([[[DTO items] objectAtIndex:0] stringForKey:@"title"], @"Sample Item");
