...
@property (retain, nonatomic, readonly) CompaniesViewModel *viewModel;
...
- (UICollectionViewDiffableDataSource<NSString *, CompanyItemModel *> *)dataSource {
...
- (CompaniesViewModel *)viewModel {
    CompaniesViewModel *viewModel = self->_viewModel;
    if (viewModel) return viewModel;

    viewModel = [[CompaniesViewModel alloc] initWithDataSource:self.dataSource];
...
- (UICollectionViewCellRegistration *)cellRegistration {
    ...
    cellRegistration = [UICollectionViewCellRegistration registrationWithCellClass:[UICollectionViewListCell class] configurationHandler:^(UICollectionViewListCell * _Nonnull cell, NSIndexPath * _Nonnull indexPath, CompanyItemModel * _Nonnull item) {
